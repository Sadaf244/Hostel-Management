...
login = tk.Button(frame, text = "Admin", width="10", bd = '3', command = Log, font = ('Times', 12, 'bold'), bg='#7268A6',relief='groove', justify = 'center', pady='5')
login.pack()
...
register = tk.Button(frame, text = "Student", width="10", bd = '3',  command = Log_Panel, font = ('Times', 12, 'bold'), bg='#2A1F2D',fg='white', relief='groove', justify = 'center', pady='5')
register.pack()
